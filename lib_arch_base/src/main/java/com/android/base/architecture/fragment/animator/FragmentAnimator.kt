...
class DefaultVerticalAnimator : FragmentAnimator {
    ...
    override fun makeOpenEnter(): Animation {
        return AnimationUtils.loadAnimation(BaseUtils.getAppContext(), R.anim.base_v_fragment_open_enter)
    }

    override fun makeOpenExit(): Animation {
        return AnimationUtils.loadAnimation(BaseUtils.getAppContext(), R.anim.base_v_fragment_open_exit)
    }

    override fun makeCloseEnter(): Animation {
        return AnimationUtils.loadAnimation(BaseUtils.getAppContext(), R.anim.base_v_fragment_close_enter)
    }

    override fun makeCloseExit(): Animation {
        return AnimationUtils.loadAnimation(BaseUtils.getAppContext(), R.anim.base_v_fragment_close_exit)
    }
...
class DefaultHorizontalAnimator : FragmentAnimator {
    ...
    override fun makeOpenEnter(): Animation? {
        return AnimationUtils.loadAnimation(BaseUtils.getAppContext(), R.anim.base_h_fragment_open_enter)
    }

    override fun makeOpenExit(): Animation? {
        return AnimationUtils.loadAnimation(BaseUtils.getAppContext(), R.anim.base_h_fragment_open_exit)
    }

    override fun makeCloseEnter(): Animation? {
        return AnimationUtils.loadAnimation(BaseUtils.getAppContext(), R.anim.base_h_fragment_close_enter)
    }

    override fun makeCloseExit(): Animation? {
        return AnimationUtils.loadAnimation(BaseUtils.getAppContext(), R.anim.base_h_fragment_close_exit)
    }
