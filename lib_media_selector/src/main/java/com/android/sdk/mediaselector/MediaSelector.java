 ...
 * 基于Boxing的多媒体文件选择器
 * <pre>
 *     FileProvider的Authorities为{@code PackageName+ ".file.provider"}才能正常工作
 * </pre>
 */
public class MediaSelector {
    ...
    public static abstract class Callback {
        ...
        public void onTakeMultiPictureSuccess(List<String> pictures) {

        }

        public void onTakePictureSuccess(String picture) {
