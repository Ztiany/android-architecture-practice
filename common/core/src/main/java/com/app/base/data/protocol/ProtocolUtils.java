...
public class ProtocolUtils {
    ...
    public static void trustAllCertificationChecked(OkHttpClient.Builder builder) {
        if (Debug.trustAllHttpsCertification()) {
    ...
    static void processHeader(UserManager userManager, AndroidPlatform androidPlatform, AppSettings appSettings, Request.Builder newBuilder) {
        newBuilder.header(ApiParameter.HEADER_CLIENT_KEY, ApiParameter.HEADER_CLIENT_VALUE);
