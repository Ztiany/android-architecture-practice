package com.app.base.compose.architect.state
...
object StateBoxDefaults {
    ...
    private var _stateConfigs: StateConfigs = StateConfigs(
        empty = StateConfig(descriptionRes = R.string.page_error_no_data, actionRes = R.string.page_error_retry_action_tips),
        error = StateConfig(
            descriptionRes = R.string.page_error_load_fail_tips,
            actionRes = R.string.page_error_retry_action_tips,
            iconRes = R.drawable.img_page_error
        ),
        netError = StateConfig(
            descriptionRes = R.string.page_error_no_network,
            actionRes = R.string.page_error_retry_action_tips,
            iconRes = R.drawable.img_page_net_error
        ),
