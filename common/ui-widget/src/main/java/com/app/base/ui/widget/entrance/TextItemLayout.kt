package com.app.base.ui.widget.entrance
...
import com.app.base.ui.widget.databinding.WidgetTextItemBinding
...
class TextItemLayout @JvmOverloads constructor(
    ...
    private fun adjustTitleToMiddle() {
        ...
        constraintSet.connect(
            ...
            ConstraintSet.START,
            getDimensionPixelSize(com.app.base.ui.theme.R.dimen.common_page_edge)
        )
        constraintSet.connect(
            viewBinding.widgetTextItemTvTitle.id,
            ConstraintSet.END,
