...
public class BannerView extends FrameLayout {
    ...
    public BannerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        /*是否可以缩放*/
        mScalable = typedArray.getBoolean(R.styleable.BannerView_bv_scale, false);
        /*用于支持5.0的transition动画*/
        mTransitionName = typedArray.getString(R.styleable.BannerView_bv_item_transition_name);
        int pageId = typedArray.getResourceId(R.styleable.BannerView_bv_pager_number_id, -1);

        typedArray.recycle();

        inflate(context, R.layout.widget_banner_view, this);

        mViewPager = getRootView().findViewById(R.id.widget_banner_vp);
